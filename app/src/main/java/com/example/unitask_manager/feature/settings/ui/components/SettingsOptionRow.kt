    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .then(
                    if (option.type != SettingsOptionType.Toggle) {
                        Modifier.clickable(
            ...
            when (option.type) {
                SettingsOptionType.Toggle -> {
                    Switch(
                        ...
                        colors = SwitchDefaults.colors(
                            checkedThumbColor = SettingsColors.TextOnPrimary,
                            checkedTrackColor = SettingsColors.PrimaryPurple,
                            uncheckedThumbColor = SettingsColors.TextOnPrimary,
                ...
                SettingsOptionType.Action -> Unit
            }
        }
...
@Composable
private fun SettingsOptionIcon(
    icon: ImageVector,
    modifier: Modifier = Modifier,
) {
    Surface(
        ...
        color = SettingsColors.IconContainer,
    ) {
        Box(contentAlignment = Alignment.Center) {
            Icon(
                imageVector = icon,
                contentDescription = null,
                tint = SettingsColors.IconTint,
